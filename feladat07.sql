...
CREATE OR ALTER VIEW VSZOBA AS --CREATE-el létrehozom, ALTER-el módosítom pl. ha átakarom nevezni az oszlop nevét, CREATE OR ALTER VIEW-mindkettőt
SELECT sz.*,
